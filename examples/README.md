...
cri run --adapter no-memory --dataset src/cri/datasets/persona-1-base/ --format json --output results/

# Run with the full-context adapter
cri run --adapter full-context --dataset src/cri/datasets/persona-1-base/ --format json --output results/

# Run with the RAG adapter
cri run --adapter rag --dataset src/cri/datasets/persona-1-base/ --format json --output results/
```
