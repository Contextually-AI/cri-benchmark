...
A **UPP (User Profiling Protocol) adapter** that connects an ontology-based memory system to the CRI Benchmark. It uses the UPP SDK to store and query structured knowledge. Requires `pip install cri-benchmark[upp]`.
