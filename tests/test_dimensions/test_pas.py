...
class TestProfileAccuracyScore:
    ...
    @pytest.mark.asyncio
    async def test_all_checks_pass(self, simple_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_all_checks_fail(self, simple_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mixed_results(self, simple_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_multi_value_dimension(self, multi_value_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_multi_value_partial_pass(self, multi_value_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_empty_profile(self, empty_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_check_id_format_single_value(self, simple_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mixed_single_and_multi_value(self, mixed_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_details_contain_expected_fields(self, simple_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_details_values_correct_on_pass(self, simple_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_details_values_correct_on_fail(self, simple_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_adapter_receives_correct_query_topics(self, simple_ground_truth: GroundTruth) -> None:
        """The adapter's retrieve() is called with the correct topic strings."""
    ...
    @pytest.mark.asyncio
    async def test_multi_value_expected_values_in_details(self, multi_value_ground_truth: GroundTruth, default_adapter: MockQueryAdapter) -> None:
