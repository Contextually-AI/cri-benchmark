...
class TestSFCForgetting:
    ...
    @pytest.mark.asyncio
    async def test_correctly_forgotten_high_score(self, forgettable_only_ground_truth: GroundTruth) -> None:
    ...
    @pytest.mark.asyncio
    async def test_still_retained_low_score(self, forgettable_only_ground_truth: GroundTruth) -> None:
    ...
    @pytest.mark.asyncio
    async def test_forget_check_ids_use_fact_id(self, forgettable_only_ground_truth: GroundTruth) -> None:
...
class TestSFCRetention:
    ...
    @pytest.mark.asyncio
    async def test_retain_check_ids_use_dimension_name(self, profile_only_ground_truth: GroundTruth) -> None:
...
class TestSFCWeightedComposite:
    ...
    @pytest.mark.asyncio
    async def test_summary_detail_contains_sub_scores(self, combined_ground_truth: GroundTruth) -> None:
        scorer = SFCDimension()
        adapter = MockAdapter()
        judge = MockBinaryJudge(
            default_verdict=Verdict.YES,
    ...
    @pytest.mark.asyncio
    async def test_per_check_details_have_sub_dimension_field(self, combined_ground_truth: GroundTruth) -> None:
        scorer = SFCDimension()
        adapter = MockAdapter()
        judge = MockBinaryJudge(default_verdict=Verdict.NO)
