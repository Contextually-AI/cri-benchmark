...
class TestListCanonicalDatasets:
    ...
    def test_discovers_new_format_datasets(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        import cri.datasets.loader as loader_module
    ...
    def test_dataset_info_has_ground_truth_flag(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        import cri.datasets.loader as loader_module
    ...
    def test_message_count_from_jsonl(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        import cri.datasets.loader as loader_module
    ...
    def test_ignores_files_at_top_level(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_ignores_dirs_without_conversations(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_dataset_info_path_is_absolute(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        import cri.datasets.loader as loader_module
