...
class TestScoringEngineConstruction:
    ...
    def test_default_config(
        self, minimal_ground_truth: GroundTruth, mock_judge: MockBinaryJudge
    ) -> None:
    ...
    def test_stores_ground_truth(
        self, engine: ScoringEngine, minimal_ground_truth: GroundTruth
    ) -> None:
    ...
    def test_dimension_registry_populated(self, engine: ScoringEngine) -> None:
        ...
        assert len(engine.dimension_registry) == 7
    ...
    def test_default_enabled_dimensions(
        self, minimal_ground_truth: GroundTruth, mock_judge: MockBinaryJudge
    ) -> None:
