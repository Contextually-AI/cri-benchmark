...
The dimension uses :func:`~cri.adapter.MemoryAdapter.get_all_facts` and
...
class MEIDimension(MetricDimension):
    ...
    name: str = "MEI"
    description: str = (
        "Memory Efficiency Index — measures the balance between "
        "storage coverage and storage efficiency."
    )
