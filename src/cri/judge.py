...
DEFAULT_JUDGE_MODEL = "claude-haiku-4-5-20250315"
...
class BinaryJudge:
    ...
    Uses :func:`litellm.completion` (synchronous) so callers do not need an
    async runtime.

    Args:
        model: LLM model identifier understood by *litellm*
            (default :data:`DEFAULT_JUDGE_MODEL`).
